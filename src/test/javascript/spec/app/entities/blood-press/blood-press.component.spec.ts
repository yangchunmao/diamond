...
import { BloodPressComponent } from 'app/entities/blood-press/blood-press.component';
...
describe('Component Tests', () => {
    describe('BloodPress Management Component', () => {
        let comp: BloodPressComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BloodPressComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.bloodPresses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
